...
DEFAULT_PROMPT_EXTRACAO = (
    ...
    "- exclusivo_me_epp (boolean: true quando o item for exclusivo para ME/EPP; false quando nao for)\n"
    ...
    "[\n"
    "  {\"numero_item\": 1, \"descricao\": \"Ventilador pulmonar eletronico...\", \"quantidade\": 5, \"unidade\": \"unidade\", \"exclusivo_me_epp\": false, \"especificacoes\": [\"modo CPAP\", \"alarme apneia\"], \"marcas_fabricantes\": []}\n"
    "]\n\n"
