    ...
    async def search(self, query: SearchQuery) -> ProviderSearchResult:
        ...
        try:
            response = await service.buscar_licitacoes(
                ...
                empresa=None,
                sub_status=None,
                tipo_instrumento_convocatorio=query.tipo_instrumento_convocatorio,
                unidade=query.unidade,
                estado=query.estado,
                municipio=query.municipio,
                esfera=query.esfera,
                poder=query.poder,
                fonte_orcamentaria=query.fonte_orcamentaria,
                margem_preferencia=query.margem_preferencia,
                conteudo_nacional=query.conteudo_nacional,
