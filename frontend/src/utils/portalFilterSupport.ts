...
const PORTAL_FILTER_PROFILES: Record<string, PortalFilterProfile> = {
  pncp: {
    ...
    guidance:
      "No PNCP, os filtros ja estao sendo tratados com a nomenclatura real da API oficial para status, instrumento, unidade, UF, municipio, esfera, poder e fonte orcamentaria.",
  },
  compras_gov: {
    key: "compras_gov",
    reliableFilters: [
    ...
    guidance:
      "No Compras.gov, os filtros agora seguem o que o endpoint oficial de licitacoes realmente expõe: numero do aviso, UASG, modalidade, periodo, orgao, municipio e UF.",
  },
  ecompras_am: {
    key: "ecompras_am",
    reliableFilters: [
