...
function CardLicitacao({
  ...
  return (
    <div
      className="group relative cursor-pointer overflow-hidden rounded-[26px] border border-line/80 bg-white shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/20 hover:shadow-soft"
    ...
    >
      <div className="flex flex-col gap-0 lg:flex-row">
        ...
        {/* Coluna de ações */}
        <div
          className="flex shrink-0 flex-row items-center justify-end gap-3 border-t border-line/60 px-6 py-4 lg:flex-col lg:items-stretch lg:justify-center lg:border-l lg:border-t-0 lg:px-5 lg:py-6 lg:pl-5"
          onClick={(e) => e.stopPropagation()}
        >
          <Link
